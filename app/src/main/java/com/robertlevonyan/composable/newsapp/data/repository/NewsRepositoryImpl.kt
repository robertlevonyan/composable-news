...
import com.robertlevonyan.composable.newsapp.data.remote.makeApiCall
...
class NewsRepositoryImpl @Inject constructor(
    ...
    override suspend fun getNews(
        ...
        limit: Int,
        offset: Int,
    ): ActionResult<NewsResponse> = makeApiCall {
        apiService.get(
    ...
    override suspend fun getSources(): ActionResult<SourceResponse> = makeApiCall {
        apiService.get(
    ...
    override suspend fun getWeather(): ActionResult<WeatherResponse> = makeApiCall {
        apiService.get(
